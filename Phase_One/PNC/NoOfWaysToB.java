...
public class NoOfWaysToB {
    ...
    static final long[] fact =new long[100101];
    static final long[] invFact =new long[100101];
    ...
    static void solve() throws Exception {
        int n=nextInt();
        int m=nextInt();
        long ans = fact[n+m]*invFact[m]%MOD;
    ...
    static void pre(){
        ...
        invFact[100100] = inv(fact[100100]);
